package webviewselenium.gui.ScanReferenceBook;
...
public class ScanReferenceController implements Initializable {
	private final static org.apache.log4j.Logger logger = ApplicationLoader.getLogger();
	// Variables bound with GUI
	@FXML private Button scanBookInQAButton;		
	...
	void goToScanBookInQAMenu(ActionEvent event) {
		...
		Stage stage = (Stage) scanBookInQAButton.getScene().getWindow();
		stage.close();
	}
	...
	public void showStage() {
		try {
			URL stageUrl = new File(ConstantFXMLPaths.scanReferenceBookMenu).toURI().toURL();
	...
	public Task<Object> createProgressTask() {
		return new Task<Object>() {
			...
			protected Object call() throws Exception {
				...
				updateProgress(0, -1);
				scanBookInQAButton.setDisable(true);
				...
				scanBookInQAButton.setDisable(false);
	...
	public static void setCurrentPageURL(String currentPageURL) {
		ScanReferenceController.currentPageURL = currentPageURL;
	}	
}
